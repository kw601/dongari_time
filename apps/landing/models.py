...
class User(AbstractUser):
    ...
    nickname = models.CharField("닉네임", max_length=20, null=False,unique=True)
    phone_num = models.CharField("전화번호", max_length=20, null=False,unique=True)
    email = models.EmailField("이메일", max_length=50, null=False,unique=True)
